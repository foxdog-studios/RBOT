...
class TemplateView
{
  ...
  public:
     ...
     *
     *  @param  object The 3D object for which the template view is to be
     * created.
     *  @param  alpha The Euler angle of the object's rotation around the x-axis
     * (in degrees).
     *  @param  beta The Euler angle of the object's rotation around the y-axis
     * (in degrees).
     *  @param  gamma The Euler angle of the object's rotation around the z-axis
     * (in degrees).
     *  @param  distance The object's distance to the camera to be used.
     *  @param  numLevels Number of template pyramid levels to be created with a
     * downscale factor of 2.
     *  @param  generateNeighbors A flag telling whether neighboring templates
     * should also be created or not.
     */
    TemplateView(Object3D* object,
                 float alpha,
                 float beta,
                 float gamma,
                 float distance,
     ...
     *
     *  @return  The object's rotation around the x-axis within the template (in
     * degrees).
     */
    float getAlpha();
     ...
     *
     *  @return  The object's rotation around the y-axis within the template (in
     * degrees).
     */
    float getBeta();
     ...
     *
     *  @return  The object's rotation around the z-axis within the template (in
     * degrees).
     */
    float getGamma();
     ...
     *  @return  The total number of pixels in the object region within the
     * template.
     */
     ...
     *
     *  @param level The pyramid level to be used.
     *  @return  The 2D signed distance transform of the binary mask of the
     * template.
     */
     ...
     *
     *  @param level The pyramid level to be used.
     *  @return  The smoothed Heaviside representation of the 2D signed distance
     ...
     *
     *  @param level The pyramid level to be used.
     *  @return  The 2D centers and IDs of all tclc-histograms in the template
     * [(x_0, y_0, id_0), (x_1, y_1, id_1), ...].
     */
  ...
  private:
    ...
    void compressTemplateData(const std::vector<cv::Point3i>& centersIDs,
...
class Parallel_For_convertToHeaviside : public cv::ParallelLoopBody
{
  ...
  public:
    Parallel_For_convertToHeaviside(const cv::Mat& sdt,
                                    cv::Mat& heaviside,
                                    int threads)
    {
        _sdt = sdt;
