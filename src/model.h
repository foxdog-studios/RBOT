...
class Model
{
  ...
  public:
     ...
     *  @param  primitives The primitive type that shall be used for drawing
     * (e.g. GL_POINTS, GL_LINES,...). The default value is set to GL_TRIANGLES.
     */
     ...
     *
     *  @return The normalization matrix of the model, applied before its 6DOF
     * pose.
     */
